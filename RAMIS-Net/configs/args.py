...
def get_args():
    ...
    parser.add_argument('--context_loss_full_coef', type=float, default=0.01, help='RARA Loss full weight')
    parser.add_argument('--token_loss', type=str, default='L1', help='token loss type [L1, MSE]')
    parser.add_argument('--token_loss_coef', type=float, default=0.05, help='MISA token loss weight')
    parser.add_argument('--recon_loss', type=str, default='L1', help='reconstruction loss')
    parser.add_argument('--recon_loss_coef', type=float, default=0.01, help='reconstruction loss weight')
    ...
    parser.add_argument('--test_p', type=float, default=0.2, help='test percentage')
    parser.add_argument('--progress_p', type=float, default=0.1, help='progress report frequency')
    parser.add_argument('--validation_p', type=float, default=0.1, help='validation percentage')
